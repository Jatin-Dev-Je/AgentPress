  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50">
      ...
      <div className="relative flex min-h-screen">
        <aside className="hidden w-72 shrink-0 border-r border-white/10 bg-zinc-950/40 lg:block">
          <div className="flex h-full flex-col p-5">
            ...
            <div className="mt-auto pt-6">
              ...
              <button
                onClick={onLogout}
                className="mt-3 inline-flex h-11 w-full items-center justify-center rounded-2xl border border-white/10 bg-white/5 px-4 text-sm font-medium text-zinc-100 transition hover:bg-white/10 disabled:opacity-50"
                disabled={loading}
              >
                Logout
              </button>
          ...
          <header className="border-b border-white/10 bg-zinc-950/40">
            <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  onClick={onLogout}
                  className="inline-flex h-10 items-center justify-center rounded-full border border-white/10 bg-white/5 px-4 text-sm font-medium text-zinc-100 transition hover:bg-white/10 disabled:opacity-50 lg:hidden"
                  disabled={loading}
                >
                  Logout
                </button>
